...
describe SecretStore::Secret do
  ...
  let(:example_iv) { "a9ETWqaR0_zKPwhv0dioOw==" }
  let(:example_crypted_text) { "DTAP0J-fyloaQAQV9XMfiMxO6TWpYSsHTt-5LjncH3I=" }
  ...
  describe "class methods" do
    describe "#new" do
      it "creates valid, decryptable object" do
        secret = SecretStore::Secret.new( example_label, example_iv, example_crypted_text )
  ...
  describe "instance methods" do
    ...
    describe "#decrypt_text" do
      ...
      it "does not change iv, or crypted text" do
        expect( subject.decrypt_text( example_key) ).to eql example_plaintext
