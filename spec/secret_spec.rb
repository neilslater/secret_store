...
describe SecretStore::Secret do
  ...
  describe "class methods" do
    describe "#new" do
      it "creates valid, decryptable object" do
        secret = SecretStore::Secret.new( example_label, example_iv, example_pbkdf2_salt, example_crypted_text, example_auth_tag )
  ...
  describe "instance methods" do
    subject { SecretStore::Secret.new( example_label, example_iv, example_pbkdf2_salt, example_crypted_text, example_auth_tag ) }
